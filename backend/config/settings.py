...
# manage.py; en producción se configuran en el panel de hosting.
...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-376anxuw653@hxgfniv7x8&ejj011cb3u9r1p14ahhngt$10@f',
)
...
# Solo el frontend conocido puede llamar a la API.
